const authorData = {
    ...
    "meta": {
        "bg": {
            "intro": "Karel Voden пише напрегнати, интелигентни трилъри, преплитащи древни мистерии с модерни конспирации. Историите му водят читателите от сенчестите коридори на властта до границата на онова, което човечеството се осмелява да узнае. <a href='/bg/about/'>Научете повече...</a>",
            "name": "Karel Voden",
            "siteTitle": "Karel Voden | Автор"
        },
        "en": {
            "intro": "Karel Voden writes taut, intelligent thrillers that weave ancient mysteries with modern conspiracies. His stories take readers from the shadowed corridors of power to the edge of what humanity dares to know. <a href='/about/'>Learn more...</a>",
            "name": "Karel Voden",
            "siteTitle": "Karel Voden | Author"
        },
        "photo": "images/common/author-karelvoden.jpg"
    },
    "novels": [
        {
            "i18n": {
                "bg": {
                    "cover": "images/bg/gnostichnia-shifar.webp",
